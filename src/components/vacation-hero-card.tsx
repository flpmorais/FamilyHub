...
export function VacationHeroCard({
  ...
  const otherLifecycles = LIFECYCLE_ORDER.filter(
    (l) => l !== vacation.lifecycle,
  );
        ...
        <View style={styles.bottom}>
          <View style={styles.bottomLeft}>
            ...
            <Text style={styles.dates}>
              {formatDatePt(vacation.departureDate)} —{" "}
              {formatDatePt(vacation.returnDate)}
            </Text>
          </View>
          <TouchableOpacity
            style={[
              styles.lcBadge,
              { backgroundColor: LIFECYCLE_COLOR[vacation.lifecycle] },
            ]}
            onPress={(e) => {
              e.stopPropagation();
            ...
            >
              ...
              <Text
                style={[
                  ...
                  { color: LIFECYCLE_COLOR[vacation.lifecycle] },
                ]}
              >
                {LIFECYCLE_LABEL[vacation.lifecycle]}
              </Text>
