...
export default function VacationsScreen() {
  ...
  const filterCount =
    (filterSearch ? 1 : 0) + (filterProfile ? 1 : 0) + (filterTag ? 1 : 0);
          ...
          {filterCount > 0 ? (
            <>
              <Text style={st.emptyFilterText}>
                Nenhuma viagem corresponde aos filtros activos
              </Text>
              ...
              <View style={st.filterChipRow}>
                ...
                >
                  <Text
                    style={[
                      st.chipText,
                      filterProfile === null && st.chipTextActive,
                    ]}
                  >
                    Todos
                  </Text>
                  ...
                  .map((p) => (
                    ...
                    >
                      <Text
                        style={[
                          st.chipText,
                          filterProfile === p.id && st.chipTextActive,
                        ]}
                      >
                        {p.displayName}
                      </Text>
                  ...
                  <View style={st.filterChipRow}>
                    ...
                    >
                      <Text
                        style={[
                          st.chipText,
                          filterTag === null && st.chipTextActive,
                        ]}
                      >
                        Todas
                      </Text>
                    ...
                    {tags.map((t) => (
                      ...
                      >
                        ...
                        <Text
                          style={[
                            st.chipText,
                            filterTag === t.id && st.chipTextActive,
                          ]}
                        >
                          {t.name}
                        </Text>
