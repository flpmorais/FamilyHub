  ...
  useEffect(() => {
    ...
    if (userAccount?.familyId) {
      profileRepo
        ...
        .then(setProfiles)
        .catch((err) =>
          logger.error("PackingListScreen", "loadProfiles failed", err),
        );
    }
        ...
        { text: "Cancelar", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              ...
              setError(
                err instanceof Error ? err.message : "Erro ao eliminar item.",
              );
            }
          },
        },
          ...
          >
            ...
            <View style={styles.itemInfo}>
              <Text
                style={[
                  styles.itemName,
                  item.status === "packed" && styles.itemNamePacked,
                ]}
                numberOfLines={1}
              >
                {item.name}
            ...
            >
              ...
              >
                <TouchableOpacity
                  style={[
                    styles.chip,
                    formProfileId === null && styles.chipActive,
                  ]}
                ...
                >
                  <Text
                    style={[
                      styles.chipText,
                      formProfileId === null && styles.chipTextActive,
                    ]}
                  >
                    Nenhuma
                  </Text>
                ...
                {profiles.map((p) => (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.chip,
                      formProfileId === p.id && styles.chipActive,
                    ]}
                  ...
                  >
                    <Text
                      style={[
                        styles.chipText,
                        formProfileId === p.id && styles.chipTextActive,
                      ]}
                    >
                      {p.displayName}
                    </Text>
                    ...
                    >
                      {ALL_STATUSES.map((s) => (
                        <TouchableOpacity
                          ...
                          style={[
                            styles.chip,
                            formStatus === s && styles.chipActive,
                          ]}
                        ...
                        >
                          <Text
                            style={[
                              styles.chipText,
                              formStatus === s && styles.chipTextActive,
                            ]}
                          >
                            {STATUS_LABELS[s]}
                          </Text>
