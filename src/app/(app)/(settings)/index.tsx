...
const MEAL_PLAN_ITEMS = [
  {
    ...
    route: "/(app)/(settings)/meal-plan-config",
  },
] as const;
...
const RECIPE_ITEMS = [
  {
    ...
    icon: "shape",
    route: "/(app)/(settings)/recipe-categories",
  },
  {
    label: "Etiquetas de Receitas",
    icon: "tag",
    route: "/(app)/(settings)/recipe-tags",
  },
] as const;

const VACATION_ITEMS = [
  {
    label: "Modelos de Items",
    icon: "content-copy",
    route: "/(app)/(settings)/templates",
  },
  {
    label: "Modelos de Malas",
    icon: "bag-suitcase",
    route: "/(app)/(settings)/bag-templates",
  },
  {
    label: "Modelos de Viagens",
    icon: "airplane",
    route: "/(app)/(settings)/vacation-templates",
  },
  {
    label: "Tarefas",
    icon: "clipboard-check-outline",
    route: "/(app)/(settings)/tasks",
  },
...
const SHOPPING_ITEMS = [
  {
    ...
    icon: "cart",
    route: "/(app)/(settings)/shopping-categories",
  },
] as const;
