...
export default function TaskTemplatesScreen() {
  ...
  return (
    <View style={s.container}>
      <PageHeader title="Tarefas" showBack familyBannerUri={family?.bannerUrl} />
...
const s = StyleSheet.create({
  ...
  fab: { width: 56, height: 56, borderRadius: 16, backgroundColor: '#B5451B', alignItems: 'center', justifyContent: 'center', elevation: 6 },
