...
export default function TaskTemplatesScreen() {
  ...
  async function handleDelete(item: TaskTemplate) {
    Alert.alert(
      `Eliminar "${item.title}"?`,
      "Esta tarefa será eliminada permanentemente.",
      [
  ...
  return (
    <View style={s.container}>
      ...
      <ScrollView contentContainerStyle={s.content}>
        ...
        {filteredItems.length === 0 && items.length > 0 && (
          <Text style={s.empty}>
            Nenhuma tarefa encontrada com os filtros actuais.
          </Text>
        )}
          ...
          >
            <View style={s.rowIconWrap}>
              <Icon
                ...
                size={20}
                color={item.active ? "#B5451B" : "#CCCCCC"}
              />
            </View>
            <View style={s.rowContent}>
              <Text style={[s.rowTitle, !item.active && s.rowTitleInactive]}>
                {item.title}
              </Text>
          ...
          >
            <View style={s.sheet}>
              ...
              <TextInput
                ...
                onChangeText={setFormDeadlineDays}
            ...
            >
              ...
              >
                <Text style={s.filterApplyBtnText}>
                  Ver {filteredItems.length} tarefas
                </Text>
              </TouchableOpacity>
            </ScrollView>
          </View>
