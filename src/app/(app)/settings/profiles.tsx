...
import type { Profile, ProfileStatus, UserRole } from '../../../types/profile.types';
  ...
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
          ...
          <View key={profile.id} style={styles.row}>
            <TouchableOpacity style={styles.rowContent} onPress={() => openEdit(profile)}>
              ...
              <View style={styles.rowInfo}>
                <Text
                  style={[styles.rowName, profile.status === 'inactive' && styles.rowNameInactive]}
                >
                  {profile.displayName}
                </Text>
        ...
        {profiles.length === 0 && <Text style={styles.empty}>Nenhum perfil encontrado.</Text>}
