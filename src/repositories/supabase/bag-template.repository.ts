...
export class SupabaseBagTemplateRepository implements IBagTemplateRepository {
  ...
  async getBagTemplates(familyId: string): Promise<BagTemplate[]> {
    try {
      ...
      throw new Error(
        `Erro ao carregar malas: ${err instanceof Error ? err.message : "Erro"}`,
      );
    }
  }
  ...
  async createBagTemplate(input: CreateBagTemplateInput): Promise<BagTemplate> {
    ...
    try {
      ...
      throw new Error(
        `Erro ao criar mala: ${err instanceof Error ? err.message : "Erro"}`,
      );
    }
  }
  ...
  async updateBagTemplate(
    id: string,
    data: Partial<
      Pick<BagTemplate, "name" | "color" | "sizeLiters" | "isTopLevel">
    >,
  ): Promise<BagTemplate> {
    ...
    try {
      ...
      throw new Error(
        `Erro ao actualizar mala: ${err instanceof Error ? err.message : "Erro"}`,
      );
    }
  }
  ...
  async deleteBagTemplate(id: string): Promise<void> {
    try {
      ...
      throw new Error(
        `Erro ao eliminar mala: ${err instanceof Error ? err.message : "Erro"}`,
      );
    }
  }
  ...
  async countItemsUsingBag(bagId: string): Promise<number> {
    ...
    if (vbErr)
      logger.error(
        "BagTemplateRepository",
        "countItemsUsingBag vacation_bags failed",
        vbErr,
      );
    if (tbErr)
      logger.error(
        "BagTemplateRepository",
        "countItemsUsingBag vacation_template_bags failed",
        tbErr,
      );
