...
export interface IRecipeRatingRepository {
  ...
  getSummariesForRecipes(recipeIds: string[]): Promise<Map<string, RecipeRatingSummary>>;
  upsertRating(recipeId: string, profileId: string, rating: number): Promise<void>;
