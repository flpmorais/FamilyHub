...
export interface IRecipeImportRepository {
  ...
  extractFromYoutube(videoId: string, model?: LlmModel): Promise<ExtractedRecipe>;
  extractFromPhoto(imageBase64: string, mimeType: string, model?: LlmModel): Promise<ExtractedRecipe>;
