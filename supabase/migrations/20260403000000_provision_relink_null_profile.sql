-- Fix: When an existing user_account has profile_id = NULL (e.g. after a data reseed),
-- attempt to re-link by matching an invited profile by email.
-- If no match, raise exception to block access.
