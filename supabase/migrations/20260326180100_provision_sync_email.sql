-- Migration 014: Sync profile email on enroll (Case 2)
--
-- When an invited user enrolls, update profiles.email to match the actual
-- sign-in email (in case of casing differences or Google account changes).
